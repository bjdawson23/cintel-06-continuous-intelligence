"""
continuous_intelligence_dawson.py - Project script (example).
...
Paths (relative to repo root)
    ...
    INPUT FILE: data/system_metrics_dawson.csv
    OUTPUT FILE: artifacts/system_assessment_dawson.csv
...
def main() -> None:
    ...
    long_summary_df = summary_df.unpivot(
        index=None,
        on=summary_df.columns,
